...
function ModifyUserText() {
    ...
    var replacementNotification = "You replaced " + initChar + " by " + finalChar + "\n";
    document.getElementById("replacements").innerHTML += replacementNotification;
...
function checkAnswer() {
    ...
    if (document.getElementById("textarea3").value.toLowerCase() === solutionPlaintext[currentCipher].toLowerCase() && document.getElementById("key2").value.toLowerCase() === keys[currentCipher].toLowerCase()) {
