...
function doEncrypt() {
  if(document.getElementById('hashValue').value !== document.rsatest.plaintext.value) {
  ...
  var res = rsa.encrypt(hex2aMine(document.rsatest.plaintext.value));
  var after = new Date();
  if(res) {
